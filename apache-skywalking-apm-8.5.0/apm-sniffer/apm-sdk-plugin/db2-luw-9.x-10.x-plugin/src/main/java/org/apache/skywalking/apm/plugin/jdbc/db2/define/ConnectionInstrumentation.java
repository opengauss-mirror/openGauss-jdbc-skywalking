...
public class ConnectionInstrumentation extends AbstractDB2Instrumentation {
    ...
    public InstanceMethodsInterceptPoint[] getInstanceMethodsInterceptPoints() {
        return new InstanceMethodsInterceptPoint[]{
                ...
                new InstanceMethodsInterceptPoint() {
                    ...
                    @Override
                    public String getMethodsInterceptor() {
                        return Constants.CREATE_STATEMENT_INTERCEPTOR;
                    }
                ...
                new InstanceMethodsInterceptPoint() {
                    ...
                    @Override
                    public String getMethodsInterceptor() {
                        return Constants.SET_CATALOG_INTERCEPTOR;
                    }
    ...
    protected ClassMatch enhanceClass() {
        return byName("com.ibm.db2.jcc.uw.UWConnection");
    }
