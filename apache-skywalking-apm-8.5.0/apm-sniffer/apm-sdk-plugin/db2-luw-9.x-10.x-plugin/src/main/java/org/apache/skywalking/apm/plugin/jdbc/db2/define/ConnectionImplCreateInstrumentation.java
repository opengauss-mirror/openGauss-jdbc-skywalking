...
public class ConnectionImplCreateInstrumentation extends AbstractDB2Instrumentation {

    private static final String JDBC_ENHANCE_CLASS = "com.ibm.db2.ConnectionImpl";
