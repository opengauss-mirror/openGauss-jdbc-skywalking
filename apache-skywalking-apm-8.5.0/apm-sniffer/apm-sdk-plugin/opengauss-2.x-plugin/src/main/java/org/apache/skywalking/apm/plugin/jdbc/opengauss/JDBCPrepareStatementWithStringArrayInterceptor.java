...
package org.apache.skywalking.apm.plugin.jdbc.opengauss;
 ...
 * real preparedStatement instance when the client call <code>org.opengauss.jdbc.PgConnection#prepareStatement(String,
...
public class JDBCPrepareStatementWithStringArrayInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public Object afterMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes,
        ...
        /**
         * To prevent the <code>org.opengauss.jdbc.prepareStatement(String sql)</code> method from repeating
         * interceptor, Because PGConnection call <code>org.opengauss.jdbc.prepareStatement(String sql)</code> method when
         * the second argument is empty.
         *
         * @see org.opengauss.jdbc.PgConnection#prepareStatement(String, String[])
         **/
